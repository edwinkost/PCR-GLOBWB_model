...
LUE_PARTITION_SHAPE="600,600" \
     python /home/hydrowld/github/hydrowldkost/PCR-GLOBWB_model/model/deterministic_runner.py /home/hydrowld/github/hydrowldkost/PCR-GLOBWB_model/config/lue/30sec_africa_vdevelop.ini debug \
         --hpx:threads=96
