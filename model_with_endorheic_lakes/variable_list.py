...
# satAreaFrac
pcrglobwb_variable_name = 'satAreaFrac'
netcdf_short_name[pcrglobwb_variable_name] = 'fractional saturated area'
netcdf_unit[pcrglobwb_variable_name]       = '1'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = 'area of the land surface over which the soil is fully saturated as determined with the improved Arno scheme'
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = None
latex_symbol[pcrglobwb_variable_name]      = None
...
# floodArea
pcrglobwb_variable_name = 'floodArea'
netcdf_short_name[pcrglobwb_variable_name] = 'flood_innundation_area'
netcdf_unit[pcrglobwb_variable_name]       = 'm**2'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_long_name[pcrglobwb_variable_name]  = None
description[pcrglobwb_variable_name]       = None
comment[pcrglobwb_variable_name]           = 'Flood innundation area outside the channel flood plain. Not including flood overtopping reservoirs and lakes.'
latex_symbol[pcrglobwb_variable_name]      = None
...
#############################################################################################################
# Global Nutrient Model - GNM
#############################################################################################################
# RvB 28/02/2020 : start of edits 
# GNM specific variables added

# active_water_area             : surface area of the active water components
#                                 (channel, lakes (excl. endorheic ones) and 
#                                 reservoirs) per cell [m2]
# endorheic_water_area          : surface area of the endorheic lakes [m2]
# total_active_water_area       : as above, but summed over each active water body [m2]
# total_endorheic_water_area    : as above, but summed over each endorheic lake [m2]
# active_water_volume           : water volume of the active water components
#                                 (channel, lakes (excl. endorheic ones) and 
#                                 reservoirs) per cell [m3]
# endorheic_water_volume        : water volume of the endorheic lakes [m3]
# total_active_water_volume     : as above, but summed over each active water body [m3]
# total_endorheic_water_volume  : as above, but summed over each endorheic lake [m3]
# waterBodyOutType              : mask of all selectable outlet locations per
#                                 water body type:
#                                  0: no water body (channel)
#                                 -1: endorheic lake
#                                  1: lake
#                                  2: reservoir 
#
...
# active_water_area
pcrglobwb_variable_name = 'active_water_area'
netcdf_short_name[pcrglobwb_variable_name] = 'active_water_area'
netcdf_unit[pcrglobwb_variable_name]       = 'm2'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'active_water_area'
netcdf_long_name[pcrglobwb_variable_name]  = 'active_water_area_per_cell'
description[pcrglobwb_variable_name]       = 'surface area of the active water components per cell'
comment[pcrglobwb_variable_name]           = 'includes channel and all water bodies except endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# endorheic_water_area
pcrglobwb_variable_name = 'endorheic_water_area'
netcdf_short_name[pcrglobwb_variable_name] = 'endorheic_water_area'
netcdf_unit[pcrglobwb_variable_name]       = 'm2'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'endorheic_water_area'
netcdf_long_name[pcrglobwb_variable_name]  = 'endorheic_water_area_per_cell'
description[pcrglobwb_variable_name]       = 'surface area of the endorheic water components per cell'
comment[pcrglobwb_variable_name]           = 'only covers endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# total_active_water_area
pcrglobwb_variable_name = 'total_active_water_area'
netcdf_short_name[pcrglobwb_variable_name] = 'total_active_water_area'
netcdf_unit[pcrglobwb_variable_name]       = 'm2'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'total_active_water_area'
netcdf_long_name[pcrglobwb_variable_name]  = 'total_active_water_area_per_cell'
description[pcrglobwb_variable_name]       = 'total surface area of the active water components per cell'
comment[pcrglobwb_variable_name]           = 'includes channel and all water bodies except endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# total_endorheic_water_area
pcrglobwb_variable_name = 'total_endorheic_water_area'
netcdf_short_name[pcrglobwb_variable_name] = 'total_endorheic_water_area'
netcdf_unit[pcrglobwb_variable_name]       = 'm2'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'total_endorheic_water_area'
netcdf_long_name[pcrglobwb_variable_name]  = 'total_endorheic_water_area_per_cell'
description[pcrglobwb_variable_name]       = 'total surface area of the endorheic water components per cell'
comment[pcrglobwb_variable_name]           = 'only covers endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# active_water_volume
pcrglobwb_variable_name = 'active_water_volume'
netcdf_short_name[pcrglobwb_variable_name] = 'active_water_volume'
netcdf_unit[pcrglobwb_variable_name]       = 'm3'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'active_water_volume'
netcdf_long_name[pcrglobwb_variable_name]  = 'active_water_volume_per_cell'
description[pcrglobwb_variable_name]       = 'surface volume of the active water components per cell'
comment[pcrglobwb_variable_name]           = 'includes channel and all water bodies except endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# endorheic_water_volume
pcrglobwb_variable_name = 'endorheic_water_volume'
netcdf_short_name[pcrglobwb_variable_name] = 'endorheic_water_volume'
netcdf_unit[pcrglobwb_variable_name]       = 'm3'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'endorheic_water_volume'
netcdf_long_name[pcrglobwb_variable_name]  = 'endorheic_water_volume_per_cell'
description[pcrglobwb_variable_name]       = 'surface volume of the endorheic water components per cell'
comment[pcrglobwb_variable_name]           = 'only covers endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# total_active_water_volume
pcrglobwb_variable_name = 'total_active_water_volume'
netcdf_short_name[pcrglobwb_variable_name] = 'total_active_water_volume'
netcdf_unit[pcrglobwb_variable_name]       = 'm3'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'total_active_water_volume'
netcdf_long_name[pcrglobwb_variable_name]  = 'total_active_water_volume_per_cell'
description[pcrglobwb_variable_name]       = 'total surface volume of the active water components per cell'
comment[pcrglobwb_variable_name]           = 'includes channel and all water bodies except endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# total_endorheic_water_volume
pcrglobwb_variable_name = 'total_endorheic_water_volume'
netcdf_short_name[pcrglobwb_variable_name] = 'total_endorheic_water_volume'
netcdf_unit[pcrglobwb_variable_name]       = 'm3'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'total_endorheic_water_volume'
netcdf_long_name[pcrglobwb_variable_name]  = 'total_endorheic_water_volume_per_cell'
description[pcrglobwb_variable_name]       = 'total surface volume of the endorheic water components per cell'
comment[pcrglobwb_variable_name]           = 'only covers endorheic lakes'
latex_symbol[pcrglobwb_variable_name]      = None

# waterBodyOutType
pcrglobwb_variable_name = 'waterBodyOutType'
netcdf_short_name[pcrglobwb_variable_name] = 'waterBodyOutType'
netcdf_unit[pcrglobwb_variable_name]       = '-'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'waterBodyOutType'
netcdf_long_name[pcrglobwb_variable_name]  = 'water_body_outlet_as_type'
description[pcrglobwb_variable_name]       = 'mask of all selectable outlet locations per water body type'
comment[pcrglobwb_variable_name]           = '0: no water body (channel); -1: endorheic lake; 1: lake; 2: reservoir.'
latex_symbol[pcrglobwb_variable_name]      = None

# RvB 28/02/2020: end of edit
