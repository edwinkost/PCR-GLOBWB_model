...
class Reporting(object):
    ...
    def post_processing(self):
        ...
        #-RvB 17/11/2022: post-processing for environmental flow requirements
        self.efr_post_processing()
    ...
    def efr_post_processing(self):

        # RvB 17/11/2022: post-processing of environmental flow requirements
        self.discharge_reserved_limit     = self._model.efr.discharge_reserved_limit
        self.waterdepth_reserved_limit    = self._model.efr.waterdepth_reserved_limit
        self.channelvolume_reserved_limit = self._model.efr.channelvolume_reserved_limit
