...
#############################################################################################################
# RvB 17/11/2022 : start of edits 
# variables of the environmental flow requirements added


# discharge_reserved_limit
pcrglobwb_variable_name = 'discharge_reserved_limit'
netcdf_short_name[pcrglobwb_variable_name] = 'discharge_reserved_limit'
netcdf_unit[pcrglobwb_variable_name]       = 'm3/s'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'discharge_reserved_limit'
netcdf_long_name[pcrglobwb_variable_name]  = 'discharge pertaining to the environmental flow requirements'
description[pcrglobwb_variable_name]       = 'the discharge is used to force outflow from reeservoirs, it is indicative for lakes and rivers'
comment[pcrglobwb_variable_name]           = 'estimated using the shallow flow approximation of the Manning equation'
latex_symbol[pcrglobwb_variable_name]      = None

# waterdepth_reserved_limit
pcrglobwb_variable_name = 'waterdepth_reserved_limit'
netcdf_short_name[pcrglobwb_variable_name] = 'waterdepth_reserved_limit'
netcdf_unit[pcrglobwb_variable_name]       = 'm'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'waterdepth_reserved_limit'
netcdf_long_name[pcrglobwb_variable_name]  = 'water depth pertaining to the environmental flow requirements'
description[pcrglobwb_variable_name]       = 'the water depth is used for lakes and rivers in the form of the channel volume'
comment[pcrglobwb_variable_name]           = 'not used for reservoirs'
latex_symbol[pcrglobwb_variable_name]      = None

# channelvolume_reserved_limit
pcrglobwb_variable_name = 'channelvolume_reserved_limit'
netcdf_short_name[pcrglobwb_variable_name] = 'channelvolume_reserved_limit'
netcdf_unit[pcrglobwb_variable_name]       = 'm'
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None 
netcdf_yearly_total_unit[pcrglobwb_variable_name]  = None
netcdf_standard_name[pcrglobwb_variable_name] = 'channelvolume_reserved_limit'
netcdf_long_name[pcrglobwb_variable_name]  = 'water depth pertaining to the environmental flow requirements'
description[pcrglobwb_variable_name]       = 'this volume is not available for surface water withdrawals'
comment[pcrglobwb_variable_name]           = 'it is set to zero for reservoirs'
latex_symbol[pcrglobwb_variable_name]      = None

# RvB 17/11/2022: end of edit
