...
class Groundwater(object):
    ...
    def initiate_old_style_groundwater_reporting(self,iniItems):
        ...
        try:
            ...
            self.outDailyTotUpsAvgNC = iniItems.groundwaterOptions['outDailyTotUpsAvgNC'].split(",")
            self.outMonthTotUpsAvgNC = iniItems.groundwaterOptions['outMonthTotUpsAvgNC'].split(",") 
            self.outMonthAvgUpsAvgNC = iniItems.groundwaterOptions['outMonthAvgUpsAvgNC'].split(",")
