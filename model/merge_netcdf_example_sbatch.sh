...
python merge_netcdf_files.py ${INPUT_DIR} ${OUTPUT_DIR} outDailyTotNC 1981-01-01 1981-12-31 discharge,waterTemp NETCDF4 True 1 Global53ExceptM28 defined -180 180 -90 90 0.083333333333333333333333
