...
mkdir /scratch/depfg/sutan101/data/pcrglobwb_input_arise/input_for_thailand_30sec_v20230409/
cd    /scratch/depfg/sutan101/data/pcrglobwb_input_arise/input_for_thailand_30sec_v20230409/
...
ln -s ${INPUT_DIR}/global_05min/waterUse/waterDemand/version_2021-09-13/domestic_water_demands/domestic_water_demand_historical_1960-2019.nc
ln -s ${INPUT_DIR}/global_05min/waterUse/waterDemand/version_2021-09-13/industry_water_demands/industry_water_demand_historical_1960-2019.nc
ln -s ${INPUT_DIR}/global_05min/waterUse/waterDemand/version_2021-09-13/livestock_water_demands/livestock_water_demand_05min.nc

#~ # - OLD water demand files
...
#~ # global 30 sec vegetation phenology for non irrigation land cover
...
#~ -rw-r--r-- 1 sutan101 depfg  15G Apr  8 16:14 composite-short-n-tall_crop_coefficient_sea_india.nc
#~ -rw-r--r-- 1 sutan101 depfg  14G Apr  8 16:13 composite-short-n-tall_intercept_capacity_sea_india.nc
#~ -rw-r--r-- 1 sutan101 depfg 1.3K Apr  8 14:54 compress.sh
#~ -rw-r--r-- 1 sutan101 depfg  518 Apr  8 14:32 gridded_30sec_sea_india.txt
...
ln -s ${INPUT_DIR}/thailand_30sec/routing/surface_water_bodies/south-east-asia_india_version_2023-03-23/lakes_and_reservoirs_30sec_sea_india_version_20230323_compressed.nc
