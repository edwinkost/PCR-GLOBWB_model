...
# load software on eejit (somehow pcraster we have to use pcraster 4.3 if we want to use the multicore module of pcraster)
source activate /eejit/home/hydrowld/opt/miniconda3/envs/pcrglobwb_python3_pcraster43_v2024-08-30
